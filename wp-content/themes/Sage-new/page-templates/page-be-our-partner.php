...
?>>
    <div class="real_w layout_2col">
        ...
        <div class="left">
            ...
            <div class="reg-form">
                <form action="" method="post" id="frmBeOurPartner">
                    ...
                    <div class="form-group">
                        <button class="btn btn-reg"><?php _e('Gửi thư', SHORT_NAME) ?></button>
                    </div>
                    <input type="hidden" name="action" value="request_be_our_partner" />
                </form>
            </div>
